...
export default class SfmcApp {
    ...
    authenticate(tokenId = '') {
        ...
        return this.submitRequest('Auth').then(r => {
    ...
    checkContext() {
        this.submitRequest('Context').then(r => {
    ...
    getSchema() {
        return this.submitRequest('GetSchema').then(r => {
            console.log(r);
    ...
    insertRecordsByKey(deKey, items) {
        ...
        return this.submitRequest('InsertDataByKey', options).then(r => {
    ...
    insertRecords(deKey, items) {
        ...
        return this.submitRequest('InsertDERecords', options).then(r => {
            console.log(`${r.length} record(s) inserted.`);
    ...
    sendSms(message, mobileNumbers, keyword) {
        ...
        return this.submitRequest('SendSms', options).then(r => {
    ...
    createCBFolder(folderPath, parentId = 0) {
        ...
        return this.submitRequest('CreateCBFolder', options).then(r => {
    ...
    getCBAsset(id) {
        ...
        return this.submitRequest('GetCBAsset', options).then(r => {
            return r;
        }).catch(e => {
            console.log(`${e}`);
            return false;
    ...
    insertCBAsset(file, name, parentId) {
        ...
        return this.submitRequest('InsertCBAsset', options).then(r => {
            return r;
        }).catch(e => {
            console.log(`${e}`);
            throw e;
...
//# sourceMappingURL=sfmcapp.js.map